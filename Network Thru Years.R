...
rm(list = ls())
setwd('C:/Users/jcarl/OneDrive/Desktop/Analysis Thru Time')
...
outdegree_evol <- outdegree_evol + theme(plot.title=element_text(size=20, face="bold"), 
...
ggsave("Outdegree Thru Years.svg", outdegree_evol, device = svg, height = 5, width = 10) #save
...
indegree_evol <- indegree_evol + theme(plot.title=element_text(size=20, face="bold"), 
                                         axis.text.x=element_text(size=10), 
                                         axis.text.y=element_text(size=10),
                                         axis.title.x=element_text(size=20),
                                         axis.title.y=element_text(size=20)) 
...
ggsave("Indegree Thru Years.svg", indegree_evol, device = svg, height = 5, width = 10) #save
...
hub_evol <- hub_evol + theme(plot.title=element_text(size=20, face="bold"), 
                                         axis.text.x=element_text(size=10), 
                                         axis.text.y=element_text(size=10),
                                         axis.title.x=element_text(size=20),
                                         axis.title.y=element_text(size=20)) 
...
ggsave("Hub Score Thru Years.svg", hub_evol, device = svg, height = 5, width = 10) #save
...
aut_evol <- aut_evol + theme(plot.title=element_text(size=20, face="bold"), 
                             axis.text.x=element_text(size=10), 
                             axis.text.y=element_text(size=10),
                             axis.title.x=element_text(size=20),
                             axis.title.y=element_text(size=20)) 
...
ggsave("Authority Thru Years.svg", aut_evol, device = svg, height = 5, width = 10) #save
...
gdp_evol <- gdp_evol + theme(plot.title=element_text(size=20, face="bold"), 
                             axis.text.x=element_text(size=10), 
                             axis.text.y=element_text(size=10),
                             axis.title.x=element_text(size=20),
                             axis.title.y=element_text(size=20)) 
...
ggsave("GDP Thru Years.svg", gdp_evol, device = svg, height = 5, width = 10) #save
...
gdp <- gdp + theme(plot.title=element_text(size=20, face="bold"), 
                             axis.text.x=element_text(size=10), 
                             axis.text.y=element_text(size=10),
                             axis.title.x=element_text(size=20),
                             axis.title.y=element_text(size=20)) 
...
ggsave("GDP Thru Years.svg", gdp, device = svg, height = 5, width = 10)
...
den <- den + theme(plot.title=element_text(size=20, face="bold"), 
                   axis.text.x=element_text(size=10), 
                   axis.text.y=element_text(size=10),
                   axis.title.x=element_text(size=20),
                   axis.title.y=element_text(size=20)) 
...
ggsave("Density Thru Years.svg", den, device = svg, height = 5, width = 10)
...
as_gdp <- as_gdp + theme(plot.title=element_text(size=20, face="bold"), 
                   axis.text.x=element_text(size=10), 
                   axis.text.y=element_text(size=10),
                   axis.title.x=element_text(size=20),
                   axis.title.y=element_text(size=20)) 
...
ggsave("GDP Assortativity Thru Years.svg", as_gdp, device = svg, height = 5, width = 10)
...
as_oecd <- as_oecd + theme(plot.title=element_text(size=20, face="bold"), 
                         axis.text.x=element_text(size=10), 
                         axis.text.y=element_text(size=10),
                         axis.title.x=element_text(size=20),
                         axis.title.y=element_text(size=20)) 
...
ggsave("OECD Assortativity Thru Years.svg", as_oecd, device = svg, height = 5, width = 10)
...
as_region<- as_region + theme(plot.title=element_text(size=20, face="bold"), 
                           axis.text.x=element_text(size=10), 
                           axis.text.y=element_text(size=10),
                           axis.title.x=element_text(size=20),
                           axis.title.y=element_text(size=20)) 
...
ggsave("Region Assortativity Thru Years.svg", den, device = svg, height = 5, width = 10)
