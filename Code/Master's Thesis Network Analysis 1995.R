...
png(filename="1995 World Trade Network.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
plot(network_1995, 
     ...
     vertex.size = V(network_1995)$GDP,
     vertex.label.cex = .7,
     edge.arrow.size = .1, 
     edge.width = 2,
     layout = fruch_layout,
...
png(filename="1995 Outdegree.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="1995 Indegree.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="1995 Betweeness.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="1995 Undirected Betweeness.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="1995 Communities.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="1995 authorities.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
OutDegree_v_GDP <- ggplot(net_data_1995, aes(x = out.degree, y = Country.Scaled.GDP)) + # Data 
  ...
  labs(x="Out Degree", y="Gross Domestic Product") +
...
ggsave("Outdegree GDP Plot 1995.png", OutDegree_v_GDP_F, device = png) #save
...
InDegree_v_GDP <- ggplot(net_data_1995, aes(x = in.degree, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="In Degree", y="Gross Domestic Product") + 
  theme(legend.position = "none")# Labels
...
ggsave("Indegree GDP Plot 1995.png", InDegree_v_GDP_F, device = png) #save
...
Katz_v_GDP <- ggplot(net_data_1995, aes(x = katz, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Katz Centrality", y="Gross Domestic Product") + 
  theme(legend.position = "none")# Labels
...
ggsave("Katz GDP Plot 1995.png", Katz_v_GDP_F, device = png,
...
Eigen_v_GDP <- ggplot(net_data_1995, aes(x = eigenvector.cent, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Eigenvector Centrality", y="Gross Domestic Product") +
  theme(legend.position = "none")# Labels
...
ggsave("Betweenesss GDP Plot 1995.png", Bet_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
Hub_v_GDP <- ggplot(net_data_1995, aes(x = hub.level, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Hub Centrality", y="Gross Domestic Product") +
  theme(lengend.position = "none")# Labels
...
ggsave("Hub GDP Plot 1995.png", Hub_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
Aut_v_GDP <- ggplot(net_data_1995, aes(x = authority.level, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Authority Centrality", y="Gross Domestic Product") +
  theme(lengend.position = "none")# Labels
...
ggsave("Authority GDP Plot 1995.png", Aut_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
ggsave("Outdegree GDP Reg 1995.png", OutDegree_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
ggsave("Indegree GDP Reg 1995.png", InDegree_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
ggsave("Katz GDP Reg 1995.png", Katz_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
ggsave("Betweeness GDP Reg 1995.png", Bet_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
Hub_v_GDP <- ggplot(net_data_1995, aes(x = hub.level, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Hub Centrality", y="log(Gross Domestic Product)") +
  theme(lengend.position = "none")# Labels
...
ggsave("Hub GDP Reg 1995.png", Hub_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
Aut_v_GDP <- ggplot(net_data_1995, aes(x = authority.level, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(x="Authority Centrality", y="log(Gross Domestic Product)") + 
  theme(lengend.position = "none")# Labels
...
ggsave("Athority GDP Reg 1995.png", Aut_v_GDP_F, device = png,
       height = 5, width = 10) #save
...
ggsave("Indegree Hist 1995.png", In_Degree_Hist, device = png,
       height = 5, width = 10) #save
...
ggsave("Outdegree Hist 1995.png", Out_Degree_Hist, device = png,
       height = 5, width = 10) #save
...
ggsave("Katz Hist 1995.png", Katz_Degree_Hist, device = png,
       height = 5, width = 10) #save
...
ggsave("Authority Hist 1995.png", Aut_Degree_Hist, device = png,
       height = 5, width = 10) #save
...
ggsave("Hub Hist 1995.png", Hub_Degree_Hist, device = png,
       height = 5, width = 10) #save
