...
rm(list = ls())
setwd('C:/Users/jcarl/OneDrive/Desktop/Working Space 1995') #change if need be
#------------------------------------------------------------------------------------------------
...
tech_1995 <- read.csv("1995_TechMatrix.csv", header=T, row.names = 1) #upload 1995 technology matrix 

matrix_1995 <- as.matrix(tech_1995) #coerce into matrix 
...
network_1995 <- graph_from_adjacency_matrix(matrix_1995, mode = "directed", diag = F) 
...
attributes <- read.csv("Country_Attributes_1995.csv", header=T) 
...
V(network_1995)$GDP=attributes[match(V(network_1995)$name, attributes$Country), 
                               "Scaled_GDP"] 

V(network_1995)$True_GDP=attributes[match(V(network_1995)$name, attributes$Country), 
                               "GDP"] 

V(network_1995)$Region=factor(attributes[match(V(network_1995)$name, attributes$Country),
                                         "Region"]) 

V(network_1995)$Income = factor(attributes[match(V(network_1995)$name, attributes$Country), 
                                           "Income_Group"]) 

V(network_1995)$OECD = factor(attributes[match(V(network_1995)$name, attributes$Country),
                                         "OECD_Membership"]) 
...
svg("1995 World Trade Network.svg")

plot(network_1995, vertex.frame.color = NA, vertex.size = V(network_1995)$GDP,
  vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2,
  layout = fruch_layout, main = "1995 World Trade Network")
...
svg("1995 World Trade Network OECD.svg")

colorscheme_OECD <- brewer.pal(3, "Paired")

V(network_1995)$color=colorscheme_OECD[as.numeric(V(network_1995)$OECD)] # Color according to OECD membership
...
svg("1995 Network by Outdegree.svg")
...
plot(network_1995, vertex.frame.color = NA, vertex.size = out_degree,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout
     ,main = "1995 World Trade Network Sized by Outdegree")
...
svg("1995 World Trade Network Sized by Indegree.svg")

plot(network_1995, vertex.frame.color = NA, vertex.size = in_degree,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout)
...
svg("1995 World Trade Network Sized by Betweeness.svg")

plot(network_1995, vertex.frame.color = NA, vertex.size = bet_cent,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "1995 World Trade Network Sized by Betweeness Centrality")
...
undirected_network_1995 <- graph_from_adjacency_matrix(matrix_1995,
...
svg("Undirected 1995 World Trade Network by Betweeness.svg")

plot(undirected_network_1995, vertex.frame.color = NA, vertex.size = undirected_bet_cent/10,
          vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = undirected_fruch_layout,
     main = "1995 Undirected World Trade Network Sized by Betweeness Centrality")
...
sev("1995 World Trade Network by Katz.svg")

katz <- alpha.centrality(network_1995, nodes= V(network_1995), alpha = .3)

plot(network_1995, vertex.frame.color = NA, vertex.size = katz*5,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "1995 World Trade Network sized by Katz Centrality")
...
undirected_eigen <- eigen_centrality(undirected_network_1995, scale = T) 
    #eigenvector. It is a list. Must extract vector for plotting. eigen$vector 

plot(undirected_network_1995, vertex.frame.color = NA, vertex.size = undirected_eigen$vector*20,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout)
...
svg("Undirected 1995 World Trade Network Community.svg")

bet_community <- edge.betweenness.community(undirected_network_1995) 

plot(bet_community, undirected_network_1995, layout = fruch_layout,
     main = "1995 World Trade Network by Communities", 
     sub = "Communities Detection Based on Edge Betweeness - Newman & Girvan (2004)") #plot communities 
...
assortativity(network_1995, V(network_1995)$GDP)

assortativity_nominal(network_1995, V(network_1995)$Income)

#   5.2.3 - Assortativity by OECD Membership

assortativity_nominal(network_1995, V(network_1995)$OECD)
...
svg("Hub Centrality 1995 World Trade Network.svg")

hubs <- hub_score(network_1995, weights = NA)$vector

plot(network_1995, vertex.frame.color = NA, vertex.size = hubs*20,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "1995 World Trade Network Hubs")
...
svg("Authority Centrality 1995 World Trade Network.svg")

authorities <- authority_score(network_1995, weights = NA)$vector 

plot(network_1995, vertex.frame.color = NA, vertex.size = authorities*20,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "1995 World Trade Network Authorities")
...
Country <- V(network_1995)$name 
Country_GDP <- V(network_1995)$True_GDP 
Country_Scaled_GDP <- V(network_1995)$GDP
Country_Region <-attributes[match(Country, attributes$Country), 
                             "Region"]
com_membership <- factor(membership(bet_community))

net_data_1995 <- tibble(year = 1995,
                        Country = Country, 
...
net_data_1995$Country.Scaled.GDP <- rescale(net_data_1995$Country.Scaled.GDP, c(0,7.64)) 
  #RESCALE GDP FOR EACH YEAR. IMPORTANT. This rescales to trillions.

write.csv(net_data_1995, "Network Data 1995.csv")
...
attach(net_data_1995)

# 8.1 Outdegree ~ GDP 

svg("Outdegree 1995 Reg Diagnostics.svg")
...
svg("Indegree 1995 Reg Diagnostics.svg")
...
svg("Katz reg 1995 diagnostics.svg")
...
svg("Betweness reg 1995 diagnostics.svg")
...
svg("Hub 1995 reg diagnostics.svg")
...
svg("authority reg 1995 diagnostics.svg")
...
OutDegree_v_GDP <- ggplot(net_data_1995, aes(x = out.degree, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme  
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Out Degree & GDP", x="Out Degree", y="Gross Domestic Product") # Labels
...
ggsave("Outdegree GDP Plot 1995.svg", OutDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save


# 9.2 In Degree and GDP

InDegree_v_GDP <- ggplot(net_data_1995, aes(x = in.degree, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="In Degree & GDP", x="In Degree", y="Gross Domestic Product") # Labels
...
ggsave("Indegree GDP Plot 1995.svg", InDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 9.3 Katz Centrality and GDP 

Katz_v_GDP <- ggplot(net_data_1995, aes(x = katz, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Katz Centrality & GDP", x="Katz Centrality", y="Gross Domestic Product") # Labels
...
ggsave("Katz GDP Plot 1995.svg", Katz_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 9.4 Eigenvector Centrality and GDP


Eigen_v_GDP <- ggplot(net_data_1995, aes(x = eigenvector.cent, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Eigenvector Centrality & GDP", x="Eigenvector Centrality", y="Gross Domestic Product") # Labels
...
Bet_v_GDP <- ggplot(net_data_1995, aes(x = betweeness, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Betweeness Centrality & GDP", x="Betweeness Centrality", y="Gross Domestic Product") # Labels
...
ggsave("Betweenesss GDP Plot 1995.svg", Bet_v_GDP_F, device = svg,
       height = 5, width = 10) #save


# 9.6 Hub Centrality and GDP 

Hub_v_GDP <- ggplot(net_data_1995, aes(x = hub.level, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Hub Centrality & GDP", x="Hub Centrality", y="Gross Domestic Product") # Labels
...
ggsave("Hub GDP Plot 1995.svg", Hub_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 9.7 Authority Centrality and GDP 

Aut_v_GDP <- ggplot(net_data_1995, aes(x = authority.level, y = Country.Scaled.GDP)) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  theme_light() + # Theme
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Authority Centrality & GDP", x="Authority Centrality", y="Gross Domestic Product") # Labels
...
ggsave("Authority GDP Plot 1995.svg", Aut_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
OutDegree_v_GDP <- ggplot(net_data_1995, aes(x = out.degree, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=out.degree, y=log(Country.GDP))) + # Regression Line
  theme_light() + # Theme  
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Out-Degree & GDP Regression", x="Out-Degree", y="Log(Gross Domestic Product)") # Labels
...
ggsave("Outdegree GDP Reg 1995.svg", OutDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 10.2 In Degree and GDP

InDegree_v_GDP <- ggplot(net_data_1995, aes(x = in.degree, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=in.degree, y=log(Country.GDP))) + #Regression Line
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="In-Degree & GDP Regression", x="In-Degree", y="Log(Gross Domestic Product)") # Labels
...
ggsave("Indegree GDP Reg 1995.svg", InDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save


# 10.3 Katz Centrality and GDP 

Katz_v_GDP <- ggplot(net_data_1995, aes(x = katz, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=katz, y=log(Country.GDP))) + # Regression Line
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Katz Centrality & GDP Regression", x="Katz Centrality",
...
ggsave("Katz GDP Reg 1995.svg", Katz_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 10.4 Betwenness Centrality and GDP 

Bet_v_GDP <- ggplot(net_data_1995, aes(x = betweeness, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=betweeness, y=log(Country.GDP))) + # Regression Line
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Betweeness Centrality & GDP", x="Betweeness Centrality",
       y="log(Gross Domestic Product)") # Labels
...
ggsave("Betweeness GDP Reg 1995.svg", Bet_v_GDP_F, device = svg,
       height = 5, width = 10) #save

# 10.5 Hub Centrality and GDP 

Hub_v_GDP <- ggplot(net_data_1995, aes(x = hub.level, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=hub.level, y=log(Country.GDP))) + # Regression Line
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Hub Centrality & GDP Regression", x="Hub Centrality",
       y="log(Gross Domestic Product)") # Labels
...
ggsave("Hub GDP Reg 1995.svg", Hub_v_GDP_F, device = svg,
       height = 5, width = 10) #save


# 10.6 Authority Centrality and GDP 

Aut_v_GDP <- ggplot(net_data_1995, aes(x = authority.level, y = log(Country.GDP))) + # Data 
  geom_point(size = 3, aes(color = Region)) +  # Scatterplot specification
  stat_smooth(method = lm, aes(x=authority.level, y=log(Country.GDP))) + # Regression Line
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Authority Centrality & GDP Regression", x="Authority Centrality", 
       y="log(Gross Domestic Product)") # Labels
...
ggsave("Athority GDP Reg 1995.svg", Aut_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
In_Degree_Hist <- ggplot(data=net_data_1995, aes(in.degree)) + 
                  geom_histogram(breaks=seq(0, 10, by = 1), col="black", aes(fill=..count..)) + 
                  labs(title = "Histogram of In-Degree of World Trade Network in 1995") + 
...
ggsave("Indegree Hist 1995.svg", In_Degree_Hist, device = svg,
       height = 5, width = 10) #save

# 11.2 - Out-degree Histogram 

Out_Degree_Hist <- ggplot(data=net_data_1995, aes(out.degree)) + 
  geom_histogram(breaks=seq(0, 30, by = 1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Out-Degree of World Trade Network in 1995") + 
...
ggsave("Outdegree Hist 1995.svg", Out_Degree_Hist, device = svg,
       height = 5, width = 10) #save


# 11.3 - Katz Centrality Histogram

Katz_Degree_Hist <- ggplot(data=net_data_1995, aes(katz.cent)) + 
  geom_histogram(breaks=seq(0, 30, by = 1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Katz Centrality of World Trade Network in 1995") + 
...
ggsave("Katz Hist 1995.svg", Katz_Degree_Hist, device = svg,
       height = 5, width = 10) #save


# 11.4 - Authority Histogram 

Aut_Degree_Hist <- ggplot(data=net_data_1995, aes(authority.level)) + 
  geom_histogram(breaks=seq(0, 1, by = .1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Authority of 1995 World Trade Network in 1995") + 
...
ggsave("Authority Hist 1995.svg", Aut_Degree_Hist, device = svg,
       height = 5, width = 10) #save


# 11.5 - Hub Histogram 

Hub_Degree_Hist <- ggplot(data=net_data_1995, aes(hub.level)) + 
  geom_histogram(breaks=seq(0, 1, by = .1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Hub Index of World Trade Network in 1995") + 
  labs(x = "Authority Index", y = "Count") + 
  xlim(c(0,1)) + 
  ylim(c(0,5))
...
ggsave("Hub Hist 1995.svg", Hub_Degree_Hist, device = svg,
       height = 5, width = 10) #save
