...
rm(list = ls())
setwd('C:/Users/jcarl/OneDrive/Desktop/Working Space 2005')
#------------------------------------------------------------------------------------------------
...
svg("2005 World Trade Network.svg")
...
svg("2005 Network by Outdegree.svg")
...
plot(network_2005, vertex.frame.color = NA, vertex.size = out_degree,
     ...
     ,main = "2005 World Trade Network Sized by Outdegree")
...
svg("2005 World Trade Network Sized by Indegree.svg")

plot(network_2005, vertex.frame.color = NA, vertex.size = in_degree,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2005 World Trade Network Sized by In-degree")
...
svg("2005 World Trade Network Sized by Betweeness.svg")

plot(network_2005, vertex.frame.color = NA, vertex.size = rescale(bet_cent, c(7, 30)),
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2005 World Trade Network Sized by Betweeness Centrality")
...
svg("Undirected 2005 World Trade Network by Betweeness.svg")
...
plot(undirected_network_2005, vertex.size = undirected_bet_cent/20, vertex.frame.color = NA,
     ...
     main = "2005 Undirected World Trade Network Sized by Betweeness Centrality")
...
sev("2005 World Trade Network by Katz.svg")
...
svg("Undirected 2005 World Trade Network Community.svg")
...
svg("Hub Centrality 2005 World Trade Network.svg")
...
svg("Authority Centrality 2005 World Trade Network.svg")
...
plot(network_2005, vertex.frame.color = NA, vertex.size = authorities*20,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2005 World Trade Network Authorities")
...
In_Degree_Hist <- ggplot(data=net_data_2005, aes(in.degree)) + 
  ...
  labs(title = "Histogram of In-Degree of World Trade Network in 2005") + 
...
ggsave("Indegree Hist 2005.svg", In_Degree_Hist, device = svg,
       height = 5, width = 10) #save
...
Out_Degree_Hist <- ggplot(data=net_data_2005, aes(out.degree)) + 
  ...
  labs(title = "Histogram of Out-Degree of World Trade Network in 2005") + 
...
Katz_Degree_Hist <- ggplot(data=net_data_2005, aes(katz.cent)) + 
  geom_histogram(breaks=seq(0, 30, by = 1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Katz Centrality of World Trade Network in 2005") + 
...
Aut_Degree_Hist <- ggplot(data=net_data_2005, aes(authority.level)) + 
  ...
  labs(title = "Histogram of Authority of 1995 World Trade Network in 2005") + 
...
Hub_Degree_Hist <- ggplot(data=net_data_2005, aes(hub.level)) + 
  geom_histogram(breaks=seq(0, 1, by = .1), col="black", aes(fill=..count..)) + 
  labs(title = "Histogram of Hub Index of World Trade Network in 2005") + 
  labs(x = "Authority Index", y = "Count") + 
  xlim(c(0,1)) + 
  ylim(c(0,5))
