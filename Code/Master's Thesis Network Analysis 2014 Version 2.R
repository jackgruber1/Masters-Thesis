...
rm(list = ls())
setwd('C:/Users/jcarl/OneDrive/Desktop/Working Space 2014') #change if need be
#------------------------------------------------------------------------------------------------
...
tech <- read.csv("2014_TechMatrix.csv", header=T, row.names = 1) #upload 2014 technology matrix 
...
plot(net, 
     ...
     edge.width = 2, 
     layout = fruch_layout,
     main = "2014 World Trade Network sized by Katz Centrality")
...
png(filename="2014 Communities.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
png(filename="2014 authorities.png", 
    type="cairo",
    units="in", 
    width= 10, 
    height=8, 
...
write.csv(net_data, "Network Data 2014.csv")
...
ggsave("Outdegree GDP Plot 2014.png", OutDegree_v_GDP_F) #save
...
ggsave("Indegree GDP Plot 2014.png", InDegree_v_GDP_F) #save
...
ggsave("Katz GDP Plot 2014.png", Katz_v_GDP_F) #save
...
ggsave("Betweenesss GDP Plot 2014.png", Bet_v_GDP_F) #save
...
ggsave("Hub GDP Plot 2014.png", Hub_v_GDP_F) #save
...
ggsave("Authority GDP Plot 2014.png", Aut_v_GDP_F)
...
ggsave("Outdegree GDP Reg 2014.png", OutDegree_v_GDP_F)
...
ggsave("Indegree GDP Reg 2014.png", InDegree_v_GDP_F)
...
ggsave("Katz GDP Reg 2014.png", Katz_v_GDP_F)
...
ggsave("Betweeness GDP Reg 2014.png", Bet_v_GDP_F)
...
ggsave("Hub GDP Reg 2014.png", Hub_v_GDP_F)
...
ggsave("Athority GDP Reg 2014.png", Aut_v_GDP_F)
...
ggsave("Indegree Hist 2014.png", In_Degree_Hist)
...
ggsave("Outdegree Hist 2014.png", Out_Degree_Hist)
...
ggsave("Katz Hist 2014.png", Katz_Degree_Hist)
...
ggsave("Hub Hist 2014.png", Hub_Degree_Hist) #save
