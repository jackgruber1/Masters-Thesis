...
png(filename="2014 World Trade Network.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
plot(network_2005, 
     ...
     vertex.size = V(network_2005)$GDP,
     vertex.label.cex = .7, 
     edge.arrow.size = .1, 
     edge.width = 2,
     layout = fruch_layout)
...
png(filename="2014 Outdegree.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
png(filename="2014 Indegree.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
png(filename="2014 Betweeness.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
plot(network_2005, 
     vertex.frame.color = NA,
     vertex.size = rescale(bet_cent, c(7, 30)),
     vertex.label.cex = .7, 
     edge.arrow.size = .1, 
     edge.width = 2, 
     layout = fruch_layout)
...
png(filename="2014 Undirected Betweeness.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
png(filename="2014 Community.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
...
plot(bet_community,
     undirected_network_2005, 
     layout = fruch_layout) #plot communities 
...
png(filename="2014 Authority.png", 
    type="cairo",
    units="in", 
    width=10, 
    height=8, 
