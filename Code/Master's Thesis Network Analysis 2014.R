#Jeancarlo Velez
#4/25/2020
#Master's Thesis Network Analysis 2014 Analysis  
...
rm(list = ls())
setwd('C:/Users/jcarl/OneDrive/Desktop/Working Space 2014')
#------------------------------------------------------------------------------------------------
...
tech_2005 <- read.csv("2014_TechMatrix.csv", header=T, row.names = 1) #upload technology matrix 
...
network_2005 <- delete.vertices(network_2005, which(degree(network_2014)==0)) # delete isolated vertices
...
attributes <- read.csv("Country_Attributes_2014.csv", header=T) 
...
svg("2014 World Trade Network OECD.svg")
...
svg("2014 Network by Outdegree.svg")
...
plot(network_2005, vertex.frame.color = NA, vertex.size = out_degree,
     ...
     ,main = "2014 World Trade Network Sized by Outdegree")
...
svg("2014 World Trade Network Sized by Indegree.svg")

plot(network_2005, vertex.frame.color = NA, vertex.size = in_degree,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2014 World Trade Network Sized by In-degree")
...
svg("2014 World Trade Network Sized by Betweeness.svg")

plot(network_2005, vertex.frame.color = NA, vertex.size = rescale(bet_cent, c(7, 30)),
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2014 World Trade Network Sized by Betweeness Centrality")
...
svg("Undirected 2014 World Trade Network by Betweeness.svg")
...
plot(undirected_network_2005, vertex.size = undirected_bet_cent/20, vertex.frame.color = NA,
     ...
     main = "2014 Undirected World Trade Network Sized by Betweeness Centrality")
...
sev("2014 World Trade Network by Katz.svg")
...
svg("Undirected 2014 World Trade Network Community.svg")

bet_community <- edge.betweenness.community(undirected_network_2005) 

plot(bet_community, undirected_network_2005, layout = fruch_layout,
     main = "2014 World Trade Network by Communities", 
...
svg("Authority Centrality 2014 World Trade Network.svg")
...
plot(network_2005, vertex.frame.color = NA, vertex.size = authorities*20,
     vertex.label.cex = .7, edge.arrow.size = .1, edge.width = 2, layout = fruch_layout,
     main = "2014 World Trade Network Authorities")
...
net_data_2005 <- tibble(year = 2014,
                        Country = Country, 
...
net_data_2005$Country.Scaled.GDP <- rescale(net_data_2005$Country.Scaled.GDP, c(0.0231,18)) 
#RESCALE GDP FOR EACH YEAR. IMPORTANT. This rescales to trillions.

write.csv(net_data_2005, "Network Data 2014.csv") #export dataset 
...
svg("Outdegree 2014 Reg Diagnostics.svg")
...
svg("Indegree 2014 Reg Diagnostics.svg")
...
svg("Katz reg 2014 diagnostics.svg")
...
svg("Betweness reg 2014 diagnostics.svg")
...
svg("Hub 2014 reg diagnostics.svg")
...
svg("authority reg 2014 diagnostics.svg")
...
OutDegree_v_GDP <- ggplot(net_data_2005, aes(x = out.degree, y = Country.Scaled.GDP)) + # Data 
  ...
  labs(title="Out Degree & GDP for World Trade Network 2014",
...
ggsave("Outdegree GDP Plot 2014.svg", OutDegree_v_GDP_F, device = svg,
...
InDegree_v_GDP <- ggplot(net_data_2005, aes(x = in.degree, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="In Degree & GDP for World Trade Network 2014",
...
ggsave("Indegree GDP Plot 2014.svg", InDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Katz_v_GDP <- ggplot(net_data_2005, aes(x = katz, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Katz Centrality & GDP for World Trade Network 2014",
...
Eigen_v_GDP <- ggplot(net_data_2005, aes(x = eigenvector.cent, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Eigenvector Centrality & GDP for World Trade Network 2014",
...
Bet_v_GDP <- ggplot(net_data_2005, aes(x = betweeness, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Betweeness Centrality & GDP for World Trade Network 2014", 
...
ggsave("Betweenesss GDP Plot 2014.svg", Bet_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Hub_v_GDP <- ggplot(net_data_2005, aes(x = hub.level, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Hub Centrality & GDP for World Trade Network 2014", 
...
ggsave("Hub GDP Plot 2014.svg", Hub_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Aut_v_GDP <- ggplot(net_data_2005, aes(x = authority.level, y = Country.Scaled.GDP)) + # Data 
  ...
  theme_light() + # Theme
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Authority Centrality & GDP for World Trade Network 2014", 
...
ggsave("Authority GDP Plot 2014.svg", Aut_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
OutDegree_v_GDP <- ggplot(net_data_2005, aes(x = out.degree, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme  
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Out-Degree & GDP Regression for World Trade Network 2014", 
...
ggsave("Outdegree GDP Reg 2014.svg", OutDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
InDegree_v_GDP <- ggplot(net_data_2005, aes(x = in.degree, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="In-Degree & GDP Regression for World Trade Network 2014", 
...
ggsave("Indegree GDP Reg 2014.svg", InDegree_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Katz_v_GDP <- ggplot(net_data_2005, aes(x = katz, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Katz Centrality & GDP Regression for World Trade Network 2014", x="Katz Centrality",
...
ggsave("Katz GDP Reg 2014.svg", Katz_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Bet_v_GDP <- ggplot(net_data_1995, aes(x = betweeness, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Betweeness Centrality & GDP for World Trade Network 2014", x="Betweeness Centrality",
       y="log(Gross Domestic Product)") # Labels
...
ggsave("Betweeness GDP Reg 2014.svg", Bet_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Hub_v_GDP <- ggplot(net_data_2005, aes(x = hub.level, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Hub Centrality & GDP Regression for World Trade Network 2014", x="Hub Centrality",
       y="log(Gross Domestic Product)") # Labels
...
ggsave("Hub GDP Reg 2014.svg", Hub_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
Aut_v_GDP <- ggplot(net_data_2005, aes(x = authority.level, y = log(Country.GDP))) + # Data 
  ...
  theme_light() + # Theme 
  scale_color_brewer(palette = "Spectral") + # Color Theme 
  labs(title="Authority Centrality & GDP Regression for World Trade Network 2014", 
...
ggsave("Athority GDP Reg 2014.svg", Aut_v_GDP_F, device = svg,
       height = 5, width = 10) #save
...
In_Degree_Hist <- ggplot(data=net_data_2005, aes(in.degree)) + 
  ...
  labs(title = "Histogram of In-Degree of World Trade Network in 2014") + 
...
ggsave("Indegree Hist 2014.svg", In_Degree_Hist, device = svg,
       height = 5, width = 10) #save
...
ggsave("Outdegree Hist 2014.svg", Out_Degree_Hist, device = svg,
       height = 5, width = 10) #save
...
ggsave("Katz Hist 2014.svg", Katz_Degree_Hist, device = svg,
       height = 5, width = 10) #save
...
ggsave("Authority Hist 2014.svg", Aut_Degree_Hist, device = svg,
       height = 5, width = 10) #save
...
ggsave("Hub Hist 2014.svg", Hub_Degree_Hist, device = svg,
       height = 5, width = 10) #save
