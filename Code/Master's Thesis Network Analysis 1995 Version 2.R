...
tech <- read.csv("1995_TechMatrix.csv", header=T, row.names = 1) #upload 1995 technology matrix 
...
write.csv(net_data, "Network Data 1995.csv")
...
stargazer(outdegree_lm, indegree_lm, bet_lm, hub_lm, aut_lm, 
          type="latex",
...
ggsave("Outdegree GDP Plot 1995.png", OutDegree_v_GDP_F) #save
...
ggsave("Indegree GDP Plot 1995.png", InDegree_v_GDP_F) #save
...
ggsave("Katz GDP Plot 1995.png", Katz_v_GDP_F) #save
...
ggsave("Betweenesss GDP Plot 1995.png", Bet_v_GDP_F) #save
...
ggsave("Hub GDP Plot 1995.png", Hub_v_GDP_F) #save
...
ggsave("Authority GDP Plot 1995.png", Aut_v_GDP_F)
...
ggsave("Outdegree GDP Reg 1995.png", OutDegree_v_GDP_F)
...
ggsave("Indegree GDP Reg 1995.png", InDegree_v_GDP_F)
...
ggsave("Katz GDP Reg 1995.png", Katz_v_GDP_F)
...
ggsave("Betweeness GDP Reg 1995.png", Bet_v_GDP_F)
...
ggsave("Hub GDP Reg 1995.png", Hub_v_GDP_F)
...
ggsave("Athority GDP Reg 1995.png", Aut_v_GDP_F)
...
ggsave("Indegree Hist 1995.png", In_Degree_Hist)
...
ggsave("Outdegree Hist 1995.png", Out_Degree_Hist)
...
ggsave("Katz Hist 1995.png", Katz_Degree_Hist)
...
ggsave("Hub Hist 1995.png", Hub_Degree_Hist) #save
